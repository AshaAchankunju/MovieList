...
urlpatterns = [
    ...
    path("goodmorning/",views.MorningView.as_view()),
    path("addition/",views.AdditionView.as_view()),
    path("bmi/",views.BmiView.as_view()),
    path("bmr/",views.CalorieView.as_view()),
    path("api/albums/",views.AlbumListView.as_view()),
    path("api/movies/",views.MovieListCreateView.as_view()),
    path("api/v1/movies/<int:pk>/",views.MovieRetrieveUpdateDestroyView.as_view()),
    path("api/movies/genre/",views.MovieGenreListView.as_view()),
    path("api/movies/language/",views.MovieLanguageListView.as_view()),
